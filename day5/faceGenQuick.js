...
function drawInstructions(){
    ...
    fill(0);
    noStroke();
    text("click anywhere to start drawing a shape, press enter to generate a new Face inside of it", 20, 20);
    pop();
    noFill();
}
...
function eyes(xLeft, xRight, y, faceHeight){
    ...
    curve(random(0, xLeft), random(0, windowHeight),
        xLeft-leftRadius*1.2, y-leftRadius*1.2,
        xLeft+leftRadius*1.2, y-leftRadius*1.2,
        random(xLeft, windowWidth), random(0, windowHeight));
    
    curve(random(0, xRight), random(0, windowHeight),
...
function mouth(xCenter, bottomThird, width, height){
    ...
    curve(random(0, windowWidth), random(0, windowHeight),
